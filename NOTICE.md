...
their own license terms. The v0.1.2 Mac installer includes PHP 8.4.25 built
...
materials are in a separate v0.1.2 Release asset, described in
...
The release [Assets](https://github.com/supdger/webman-aot/releases/tag/v0.1.2)
