...
final class StructureTest
{
    ...
    private function assertRequiredFiles(): void
    {
        $required = [
            ...
            'src/Compatibility/VersionRange.php',
            ...
            'src/Project/CoverageLedger.php',
            'src/Project/CoveragePlanner.php',
            'src/Project/DiscoveryResult.php',
            'src/Project/ProfileDetector.php',
            'src/Project/ProjectDiscovery.php',
            ...
            'src/Toolchain/NativeDownloader.php',
            'src/Toolchain/ToolchainLocator.php',
            'src/Toolchain/ToolchainRepairer.php',
            'src/Update/SignedManifestVerifier.php',
            'src/Update/CliSelfChecker.php',
            'src/Update/CliVersionStore.php',
            'src/Update/NativeCliSelfChecker.php',
            'src/Update/PackageExtractor.php',
            'src/Update/SelfUpdater.php',
            'src/Update/TrustedKeyStore.php',
            'src/Update/UpdateManifest.php',
            'src/Update/UpdateManager.php',
            'src/Update/VerifiedDownloader.php',
            'src/Update/ZipPackageExtractor.php',
            'src/Version.php',
            'toolchain/README.md',
